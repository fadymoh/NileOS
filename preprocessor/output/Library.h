...
bool generateServices()
{
	...
	register_service_to_kernel(&kernel.service_transporter, &hamadaStructService, hamadaStruct_t);
	...
	register_service_to_kernel(&kernel.service_transporter, &service1Service, service1_t);
}
