...
uint32_t timeStamp32 (uint8_t p_seconds, uint8_t p_minutes,uint8_t p_hours ,uint8_t p_day , uint8_t p_month , uint16_t p_year)
{
    ...
    for ( uint16_t i = 1970 ; i <= p_year ; i ++)
    {
        if ( i == p_year)
        {
            ...
            {
                if ( m == 1 || m == 3 || m == 5 || m == 7 || m == 8 || m == 10 || m == 12) ts += (31 * 24 *60*60);
                else if ( m == 4 || m == 6 || m == 9 || m == 11 ) ts += (30 * 24 *60*60);
                else if ( m == 2 && y == 0 ) ts += (29 * 24 *60*60);
                else if ( m == 2 && y != 0 ) ts += (28 * 24 *60*60);
            }
        ...
        else
        {
            ...
            if ( y == 0 ) ts += (366*24*60*60);
            else ts += (365*24*60*60);
        }
